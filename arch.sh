...
progsfile="https://raw.githubusercontent.com/eduuh/dotfiles/main/programs.csv"
aurhelper="yay"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to HomeLab/Desktop Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-" 10 60
...
adduserandpass() {
	...
	export repodir="/home/$name/projects"
	mkdir -p "$repodir"
